...
// The other columns are unmodified.
func (m *Matrix4) TranslateBy3Comps(x, y, z float32) *Matrix4 {
...
func (m *Matrix4) TranslateBy2Comps(x, y float32) *Matrix4 {
...
// The other columns are unmodified.
func (m *Matrix4) SetTranslate3Comp(x, y, z float32) *Matrix4 {
	m.ToIdentity()
...
//      [   _    _    _    _   ]
//      [   _    _    _    _   ]
func (m *Matrix4) SetRotation(angle float32) *Matrix4 {
	m.ToIdentity()
...
func (m *Matrix4) RotateBy(angle float32) *Matrix4 {
	if angle == 0.0 {
		return m
	}
...
// scale values into Scale property.
func (m *Matrix4) SetScale3Comp(sx, sy, sz float32) *Matrix4 {
...
func (m *Matrix4) SetScale2Comp(sx, sy float32) *Matrix4 {
...
func (m *Matrix4) PostScale(sx, sy, sz float32) *Matrix4 {
	temp.e[M00] = sx
	temp.e[M01] = 0
	temp.e[M02] = 0
	temp.e[M03] = 0
...
func (m *Matrix4) PostTranslate(tx, ty, tz float32) *Matrix4 {
	temp.e[M00] = 1.0
	temp.e[M01] = 0.0
	temp.e[M02] = 0.0
	temp.e[M03] = tx
