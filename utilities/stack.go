...
// Element is a generic type
type Element struct {
	value interface{}
	next  *Element
}

// NewStack create a new stack with "max" number of elements.
...
// IsEmpty is true if the stack's len = 0
func (s *Stack) IsEmpty() bool {
	return s.Len() == 0
}

// Max returns the stack's max
...
// PopLast removes and returns the last element from the stack.
